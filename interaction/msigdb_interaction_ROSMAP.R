...
for (x in unique(common$trait)){
	...
	write.table(subset_df2, paste0("rosmap_common_",x,"_", i, "_background_5.13.24.txt"), row.names = F, sep = ",")
	...
	write.table(sig_subset_df2, paste0("rosmap_common_only_sig_",x,"_",i, "_5.13.24.txt"), row.names = F, sep = ",")
}
}
...
for (x in unique(common$trait)){
	for (i in unique(common$assembly_comparison)){
	var1=paste0("rosmap_common_only_sig_",x,"_",i, "_5.13.24.txt")
	var2=paste0("rosmap_common_",x,"_", i, "_background_5.13.24.txt")
