...
plot_data <- do.call(rbind, Map(function(comp, old, new) {
  xcol  <- paste0("logFC|CERJ_defvsctl_", old)
  ycol  <- paste0("logFC|CERJ_defvsctl_", new)
  decol <- paste0(new, old, "DE_CERJ_defvsctl")
...
ggsave("CERJ_defvsctl_scatter_plot.pdf",g, useDingbats = FALSE, width = 17.5, height= 9)
