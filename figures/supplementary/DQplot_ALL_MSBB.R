...
data_path <- "with_signif_categories_results_assembly_MSBB_3.30.24.RDS" #AD-DEGs-genome-updates/misc/with_signif_categories_results_assembly_MSBB_3.30.24.RDS
...
output_dir <- "/assembly/"
output_pdf <- file.path(output_dir, "DQplot_ALL_MSBB.pdf")
...
for (pair in names(assembly_pairs)) {
  ...
  filename <- paste0(pair, "_DQ_plot_MSBB.pdf")
