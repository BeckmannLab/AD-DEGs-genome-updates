...
plot_data <- do.call(rbind, Map(function(comp, old, new) {
  xcol  <- paste0("logFC|cts_mmse30_", old)
  ycol  <- paste0("logFC|cts_mmse30_", new)
  decol <- paste0(new, old, "DE_cts_mmse30")
...
ggsave("cts_mmse30_scatter_plot.pdf",g, useDingbats = FALSE, width = 17.5, height= 9)
