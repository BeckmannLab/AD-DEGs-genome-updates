...
gene_map <- fread(gene_ids_ensembl2symbol_fromHUGO_10JUN2020.csv)[, .(symbol = `Approved symbol`, gene = `Ensembl gene ID`)] #see AD-DEGs-genome-updates/files/gene_ids_ensembl2symbol_fromHUGO_10JUN2020.csv
