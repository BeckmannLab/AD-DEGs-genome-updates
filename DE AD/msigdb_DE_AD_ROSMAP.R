...
folder <- "/sc/arion/projects/mscic1/results/anina/fun_project_4.23/analysis/msig/redone_7.18.25/rosmap/output/c2"
...
saveRDS(df2_c2, "hallmark_msigdb_rosmap.RDS")
...
saveRDS(df2_hallmark, "/hallmark_msigdb_rosmap.RDS")
...
grepl("DESERT", subset_df$Term)

saveRDS(all, "c2_hallmark_msigdb_rosmap.RDS") #Supplementary Table 2: ROSMAP msigdb across ref pairs
