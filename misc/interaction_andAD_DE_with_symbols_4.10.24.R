...
saveRDS(all_results, "with_signif_categories_results_AD_all_resultsDE_4.10.24.RDS")
...
# Copy merged results for analysis
interaction_rosmap = all_results
...
# save results
saveRDS(interaction_rosmap, "with_signif_categories_results_AD_all_resultsDE_4.10.24.RDS")

##Load them in to combine interaction and DE AD results
AD_DE=readRDS("with_signif_categories_results_AD_all_resultsDE_4.10.24.RDS")
interaction_DE=readRDS("with_signif_categories_results_interaction_ROSMAP_4.10.24.RDS")
...
saveRDS(interaction_and_AD_with_symbols, "interaction_andAD_DE_with_symbols_4.10.24.RDS")
