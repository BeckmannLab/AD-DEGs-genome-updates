...
df <- readRDS("interaction_andAD_DE_with_symbols_4.10.24.RDS") # see AD_DEGs-genome-updates/misc/interaction_andAD_DE_with_symbols_4.10.24.R
...
saveRDS(df_all, "rosmap_ad_interaction_results_matrix.RDS")
