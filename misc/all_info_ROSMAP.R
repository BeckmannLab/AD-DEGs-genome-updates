...
all_info_ROSMAP$for_plot=paste0(all_info_ROSMAP$direction_signif,"_", all_info_ROSMAP$in_common )

all_info_ROSMAP$assembly <- factor(all_info_ROSMAP$assembly, levels = c("GRCh37-NCBI36", "GRCh38.p12-NCBI36", "GRCh38.p13-NCBI36", "CHM13v2.0-NCBI36", "GRCh38.p12-GRCh37", "GRCh38.p13-GRCh37", "CHM13v2.0-GRCh37", "GRCh38.p13-GRCh38.p12", "CHM13v2.0-GRCh38.p12", "CHM13v2.0-GRCh38.p13"))

saveRDS(all_info_ROSMAP,"all_info_ROSMAP.RDS" )
