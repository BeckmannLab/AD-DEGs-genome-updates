...
df_clean <- all_info_MSBB[complete.cases(all_info_MSBB$in_common, all_info_MSBB$assembly, all_info_MSBB$direction, all_info_MSBB$sig_status), ]
df_clean2 <- df_clean[complete.cases(df_clean$status), ]
all_info_MSBB=df_clean2
...
all_info_MSBB$assembly <- factor(all_info_MSBB$assembly, levels = c("GRCh37-NCBI36", "GRCh38.12-NCBI36", "GRCh38.13-NCBI36", "CHM13v2.0-NCBI36", "GRCh38.12-GRCh37", "GRCh38.13-GRCh37", "CHM13v2.0-GRCh37", "GRCh38.13-GRCh38.12", "CHM13v2.0-GRCh38.12", "CHM13v2.0-GRCh38.13"))

## Save final data
saveRDS(all_info_MSBB,"with_coding_status_all_info_MSBB.RDS" )
